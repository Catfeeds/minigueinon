...
// +----------------------------------------------------------------------  	 
    ...
    'DB_NAME'               =>  'minigueinon',          // 数据库名
    'DB_USER'               =>  'root',      // 用户名
    'DB_PWD'                =>  'root',      //'1234QWERasdf',          // 密码
    'content'=>array(
        'dir' =>"/minigueinon/Data/"
    ),
    'wxpay'  =>array(
        'applyshop_notify_url'=>"https://gzleren.com/minigueinon/index.php/Api/Applyshop/wxnotifyurl",
        'wx_notify_url'       =>"https://gzleren.com/minigueinon/index.php/Api/Pay/wxnotifyurl",
        'wx_rznotify_url'       =>"https://gzleren.com/minigueinon/index.php/Api/Pay/wxrznotifyurl"
    ),
    'weixin' => array(
